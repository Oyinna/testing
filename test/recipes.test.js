...
describe('test the recipes API', () => {
    ...
    describe('GET /recipes', () => {
        ...
        it('It should retrive any recipe in db, internal server error.', async (done) => {
    ...
    describe('GET /recipes/:id', () => {
        it('Retrive a particular recipes in db', async (done) => {
            const res = await request(app)
                .get(`/recipes/${id}`)
            expect(res.statusCode).toEqual(200);
            expect(res.body).toEqual(
        ...
        it('It should not retrive any recipes from db, internal server error', async (done) => {
            // DATA YOU WANT TO SAVE TO DB
    ...
    describe('DELETE /recipes/:id', () => {
        it('Delete the identified recipe', async (done) => {
            const res = await request(app)
                .delete(`/recipes/${id}`)
                .set('Authorization', `Bearer ${token}`)
            expect(res.statusCode).toEqual(200);
        ...
        it('Fail to delete the identified recipe, invalid token', async (done) => {
            const res = await request(app)
                .delete(`/recipes/${id}`)
                .set('Authorization', 'Bearer iuhbfwdfy65434567ub')
            expect(res.statusCode).toEqual(403);
        ...
        it('Fail to delete the identified recipe, internal server error', async (done) => {
